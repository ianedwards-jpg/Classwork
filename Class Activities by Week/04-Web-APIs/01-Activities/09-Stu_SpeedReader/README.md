...
In this activity you are going to create a speed reading application. It will output a single word on the screen at a time, changing to the next word after 1 second. This equates to reading at 60 Words Per Minute (WPM).
